...
<section class="bg-white pt-5 pb-5">
  <div class="container">
    ...
    <div class="row h-100">
      ...
      <div class="d-flex">
          <a href="http://jax.network/" target="_blank" style="max-width:250px;">
            <img src="img/jax-network_logo_blue-1.svg" alt="">
            <span>Jax.Network</span>
          </a>
          <a href="http://jax.money/" target="_blank" style="max-width:250px;">
        ...
        <div class="row">
          <div class="col-12 col-sm-4">
              ...
              <div class="p-2 p-md-3 bg-lighterblue border-radius box-shadow bg-white mb-2 h-100 text-center">
                ...
                <h4 class="text-blue font-weight-normal pb-4">Total UBI Paid 
                  <br>
                  (WJAX)
                </h4>
          ...
          <div class="col-12 col-sm-4">
              ...
              <div class="p-2 p-md-3 bg-lighterblue border-radius box-shadow bg-white mb-2 h-100 text-center ">
                ...
                <h4 class="text-blue font-weight-normal pb-4">Total UBI per person
                <br>
                  (WJAX)
                </h4>
...
Learn more about UBI: <a href = "https://youtu.be/5r3DS7oQoHY">Watch Video</a>.
 </p>
              </div>
            </div>
          </div>
